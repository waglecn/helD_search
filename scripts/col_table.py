#!/usr/bin/env python3
"""
This script originally in allvsall directory. This produces the cytoscape output.

Input:
    infasta: all.fasta, all the protein sequences
    inblast: allvsall blast in outfmt 6 table format
    incluster: the usearch .uc cluster file for all sequences, ie clustered_hits/all.50.sorted.uc


Output:
    pairs.out: node pairs in A\tB format for import into Cytoscape
    nodes.csv: node metadata in csv format for import into Cytoscape
